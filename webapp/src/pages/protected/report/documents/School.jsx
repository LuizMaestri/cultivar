...
export default ({data}) =>{
    ...
    for (const key in data) {
        if (data.hasOwnProperty(key)) {
            ...
            if (!report[element.school]) {
                report[element.school] = {};
            }
            if (!report[element.school].volunteers) {
                report[element.school].volunteers = {};
            }
            if (!report[element.school].volunteers[element.cpf]) {
                report[element.school].volunteers[element.cpf] = {
                    name: element.user,
                };
            }
            if (element.project) {
                if (!report[element.school].volunteers[element.cpf].projects) {
                    report[element.school].volunteers[element.cpf].projects = {};
                }
                if (!report[element.school].volunteers[element.cpf].projects[element.project]) {
                    report[element.school].volunteers[element.cpf].projects[element.project] = {
                        ratings: []
                    };
                }
                report[element.school].volunteers[element.cpf].projects[element.project].ratings.push(element.rating);
            } else {
                if (!report[element.school].volunteers[element.cpf].events) {
                    report[element.school].volunteers[element.cpf].events = {};
                }
                ...
                report[element.school].volunteers[element.cpf].events[eventName] = {
